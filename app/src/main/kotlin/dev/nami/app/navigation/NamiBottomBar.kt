...
/** П.md §29-31: та же панель для широкого экрана, повёрнутая на бок.
 *
 * Что из §29-31 СДЕЛАНО: определение класса ширины окна через calculateWindowSizeClass и замена
 * нижней панели на рельсу при Medium/Expanded (>600dp) - то есть планшет и телефон в ландшафте
 * перестают тратить высоту на панель снизу.
 *
 * Чего НЕТ, честно: раскладки list-detail (список слева, деталь справа - для Библиотеки и
 * Плейлистов это была бы отдельная переработка каждого экрана, а не общий каркас); особых
 * ландшафтных раскладок Now Playing; поддержки FoldingFeature из androidx.window (складные
 * устройства, раскладка «книжкой» вокруг сгиба). Всё три - самостоятельные задачи, каждая
 * размером с эту, и подпирать их заглушкой было бы хуже, чем не начинать: экран, который
 * «почти» подстроился под сгиб, читается как баг, а не как отсутствующая функция.
 *
 * Своя вёрстка, а не
