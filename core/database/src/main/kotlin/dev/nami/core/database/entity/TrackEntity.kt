...
data class TrackEntity(
    ...
    /** Форма волны: 120 значений 0..1 через запятую. Хранится на треке, а не только в файловом
     * кеше по пути: путь меняется (скачанный серверный трек переезжает на реальный файл), и
