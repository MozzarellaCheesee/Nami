 ...
 * Здесь только цвет; форма - в [NamiRadius], плотность - в [NamiDensity], размытие - в
 * [NamiEffects], масштаб текста - в NamiTheme. Не сделано из плана: режимы акцента, проверка
 * контраста, пипетка с обложки. */
object NamiColors {
