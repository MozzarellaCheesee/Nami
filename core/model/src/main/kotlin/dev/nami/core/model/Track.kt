...
data class Track(
    ...
    /** id этого трека в библиотеке сервера, если связь уже установлена. Нужен, чтобы чужая
     * правка доезжала до локального файла после переименования, когда сопоставление по
     * названию уже не сработает. */
