...
class SearchRepositoryImplTest {
    ...
    private fun fakeTrackDao(
        ...
        override suspend fun updateMetadataFromServer(id: String, title: String, artistId: String?, albumId: String?, trackNo: Int?) = error("unused")
        override suspend fun setServerTrackId(id: String, serverTrackId: Long?) = error("unused")
        override suspend fun findByServerTrackId(serverTrackId: Long): TrackEntity? = error("unused")
        ...
        override suspend fun updateLastPlayed(id: String, timestamp: Long?) = error("unused")
