...
//! она есть и в бюджет её считать надо. Замер: FLAC 5 минут -> opus128 даёт пик 23 МБ RSS
//! у ffmpeg при 16 МБ у самого сервера. Одновременных транскодов столько же, сколько
//! запросов с профилем - на целевом "1 ядро / 512 МБ" это и есть настоящее ограничение.
